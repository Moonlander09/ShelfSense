...
export default function OtherItemCards() {
 ...
 if (isUserLoading) {
  ...
  return (
    <>
    <Breadcrumbs bgColor="bg-slate-50"  bgBorder="border-slate-200" textColor ="text-slate-700"/>
